(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=`
      @media(min-width:901px){.page.layout-left-right{grid-template-columns:minmax(220px,.80fr) minmax(150px,.48fr) minmax(0,2.35fr)!important;grid-template-rows:minmax(360px,.88fr) minmax(285px,1.32fr)!important}.visual-card canvas{max-width:100%!important;width:100%!important;margin-left:auto!important;margin-right:auto!important}.formula-card{max-width:72%!important;align-self:start!important;min-height:0!important}.moment-card{min-height:330px!important;align-self:stretch!important}.moment-card canvas{max-width:100%!important;width:100%!important;height:310px!important;max-height:310px!important;margin-left:auto!important;margin-right:auto!important}.formula{font-size:8px!important;line-height:1!important;min-height:165px!important;height:165px!important;max-height:165px!important;padding:5px!important;column-count:3!important;column-gap:10px!important;overflow:hidden!important}}
