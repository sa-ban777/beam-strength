(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=`
      @media(min-width:901px){.page.layout-left-right{grid-template-columns:minmax(220px,.80fr) minmax(174px,.56fr) minmax(0,2.05fr)!important}.visual-card canvas{max-width:100%!important;width:100%!important;margin-left:auto!important;margin-right:auto!important}.moment-card canvas{max-width:100%!important;width:100%!important;margin-left:auto!important;margin-right:auto!important}}
      ...
      .result-card .result-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:4px!important}
      .result-card .result-grid>div{min-height:48px!important;padding:4px 6px!important;border-radius:6px!important;display:grid!important;grid-template-columns:1fr!important;grid-template-rows:auto auto auto!important;align-items:start!important;row-gap:2px!important}
      .result-card .result-grid span{font-size:11.5px!important;line-height:1.12!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;display:block!important}
      .result-card .result-grid strong{font-size:17px!important;line-height:1.05!important;white-space:nowrap!important;text-align:left!important;grid-row:auto!important;grid-column:auto!important;display:block!important}
      .result-card .result-grid small{font-size:10px!important;line-height:1!important;white-space:normal!important;grid-column:auto!important;color:#64748b!important;display:block!important}
      ...
      @media(max-width:640px){.quick-result-bar{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:4px!important;padding:4px!important}.quick-result-item{min-height:42px!important;padding:5px 7px!important}.quick-result-item:first-child{grid-column:1/-1!important}.quick-result-item span{font-size:10.5px!important}.quick-result-item strong{font-size:15px!important}.result-card .result-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:4px!important}.result-card .result-grid>div{min-height:42px!important;padding:3px 6px!important}.result-card .result-grid span{font-size:10px!important}.result-card .result-grid strong{font-size:14px!important}.result-card .result-grid small{font-size:9px!important}.section-performance-grid{grid-template-columns:1fr!important;gap:4px!important}.section-performance-grid>div{min-height:40px!important;padding:5px 7px!important}.section-performance-grid span{font-size:11px!important}.section-performance-grid strong{font-size:13px!important}.section-performance-grid small{font-size:9px!important}}
    `;
