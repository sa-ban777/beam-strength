(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=`
      @media(min-width:901px){.page.layout-left-right{grid-template-columns:minmax(220px,.80fr) minmax(190px,.62fr) minmax(420px,1.08fr) minmax(520px,1.38fr)!important;grid-template-rows:minmax(370px,1.02fr) minmax(260px,.98fr)!important;grid-template-areas:'input result visual visual' 'input result formula moment'!important}.visual-card{min-height:0!important}.visual-split{grid-template-columns:1.15fr .85fr!important;gap:10px!important}.visual-card canvas{max-width:100%!important;width:100%!important;height:100%!important;max-height:none!important;margin-left:auto!important;margin-right:auto!important}.formula-card{align-self:stretch!important;min-height:0!important}.formula{font-size:8.7px!important;line-height:1.05!important;min-height:0!important;height:100%!important;max-height:none!important;padding:6px!important;column-count:2!important;column-gap:12px!important;overflow:hidden!important}.moment-card{min-height:0!important;align-self:stretch!important}.moment-card canvas{max-width:100%!important;width:100%!important;height:100%!important;max-height:none!important;margin-left:auto!important;margin-right:auto!important}}
