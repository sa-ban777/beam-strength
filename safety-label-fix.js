(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=`
      @media(min-width:901px){.page.layout-left-right{grid-template-columns:minmax(300px,1.00fr) minmax(370px,1.16fr) minmax(0,1.10fr)!important}.visual-card canvas{max-width:100%!important;margin-left:auto!important;margin-right:auto!important}.moment-card canvas{max-width:100%!important;margin-left:auto!important;margin-right:auto!important}}
      ...
      .result-card .result-grid>div{min-height:40px!important;padding:4px 7px!important;border-radius:6px!important;display:grid!important;grid-template-columns:1fr auto!important;grid-template-rows:auto auto!important;align-items:center!important;column-gap:6px!important;row-gap:2px!important}
      .result-card .result-grid span{font-size:11px!important;line-height:1.12!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important}
