(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=`
      @media(min-width:901px){.page.layout-left-right{grid-template-columns:minmax(220px,.80fr) minmax(174px,.56fr) minmax(0,2.05fr)!important;grid-template-rows:minmax(360px,.92fr) minmax(260px,1.18fr)!important}.visual-card canvas{max-width:100%!important;width:100%!important;margin-left:auto!important;margin-right:auto!important}.moment-card{min-height:300px!important}.moment-card canvas{max-width:100%!important;width:100%!important;height:270px!important;max-height:270px!important;margin-left:auto!important;margin-right:auto!important}.formula-card{min-height:0!important}.formula{font-size:8.5px!important;line-height:1.02!important;min-height:190px!important;height:190px!important;max-height:190px!important;padding:6px!important;column-count:3!important;column-gap:12px!important;overflow:hidden!important}}
